...
## Footer.js
`Footer.js` takes menu imports from `constants/menu-items.js` where you can declare the title and path. Depending on if these imports are present/true, the component will render the associated `<div>`.# mollymisek.com
